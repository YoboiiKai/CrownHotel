...
export default function AdminOrders({ auth }) {
  ...
  const getStatusBadgeClass = (status) => {
    switch (status) {
      ...
      case 'processing':
        return 'bg-[#A67C52]/20 hover:text-[#6B4226]';
      case 'completed':
                    ...
                    <div className="flex justify-between items-start">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="p-1.5 rounded-md bg-red-50 border border-red-200 text-red-600 hover:bg-[#A67C52]/100 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-1 transition-all"
                        >
