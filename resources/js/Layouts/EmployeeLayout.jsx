...
export default function EmployeeLayout({ children }) {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      id: "rooms",
      submenu: [
        { name: "Room Assignments", path: "/rooms/assignments" },
        { name: "Room Status", path: "/rooms/status" },
        { name: "Check Room Details", path: "/rooms/details" },
        { name: "Report Maintenance Issues", path: "/rooms/maintenance" },
        { name: "Check-ins/Check-outs", path: "/rooms/checkins" },
      ],
    },
    {
      name: "Restaurant",
      ...
      id: "restaurant",
      submenu: [
        { name: "View Orders", path: "/restaurant/orders" },
        { name: "Order Status", path: "/restaurant/order-status" },
        { name: "Manage Table", path: "/restaurant/tables" },
        { name: "Payments", path: "/restaurant/payments" },
        { name: "View Menu", path: "/restaurant/menu" },
        { name: "Stock", path: "/restaurant/stock" },
      ],
    },
    {
      name: "Inventory",
      ...
      submenu: [
        ...
        { name: "Inventory Usage", path: "/inventory/usage" },
  ...
  const serviceItems = [
    {
      ...
      id: "reservations",
      submenu: [
        { name: "Reservations", path: "/reservations/list" },
        { name: "Check Reservation Status", path: "/reservations/status" },
        { name: "Handle Walk-ins", path: "/reservations/walk-ins" },
        { name: "Receipts", path: "/reservations/receipts" },
      ],
    },
    {
      name: "Housekeeping",
    ...
    },
    {
      ...
      id: "feedback",
      submenu: [
        { name: "Feedback", path: "/feedback/view" },
        { name: "Guest Issues", path: "/feedback/issues" },
        { name: "Complaint", path: "/feedback/complaints" },
        { name: "Requests", path: "/feedback/requests" },
      ],
    },
  ]
