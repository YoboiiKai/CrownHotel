          ...
          <div className="flex items-center gap-1 sm:gap-2 md:gap-4">
            ...
            <div className="flex items-center gap-2 md:gap-3 rounded-full border border-[#5D3A1F] bg-[#8B5A2B]/60 px-2 py-1 sm:px-3 sm:py-1.5 hover:border-[#7C5E42] hover:shadow-md transition-all cursor-pointer" onClick={openLogoutModal}>
              ...
              <div className="hidden md:block pr-1">
                <p className="text-sm font-medium text-white truncate max-w-[120px] lg:max-w-[180px]">{user?.name || "Guest"}</p>
                <p className="text-xs text-amber-200">{user?.role || "Client"}</p>
              </div>
          ...
          <div className="border-t border-[#5D3A1F] p-3 sm:p-6">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm sm:font-medium text-white truncate">{user?.name || "Guest"}</p>
                <p className="text-xs text-[#DEB887]">{user?.role || "Client"}</p>
              </div>
              <button 
