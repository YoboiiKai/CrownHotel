...
export default function ClientLayout({ children }) {
  ...
  useEffect(() => {
    ...
    const setActiveMenuFromUrl = () => {
      ...
      const allMenus = [...menuItems, ...serviceItems]
  ...
  const menuItems = [
    ...
    },
    {
      ...
      id: "booking",
      submenu: [
        { name: "View Available Rooms", path: "/client/rooms" },
        { name: "Book Rooms", path: "/booking/book" },
        { name: "View Booking History", path: "/client/bookinghistory" },
      ],
    },
    {
      name: "Restaurant",
      ...
      id: "restaurant",
      submenu: [
        { name: "Menu", path: "/client/menu" },
        { name: "Order Status", path: "/client/orders" },
        { name: "Restaurant Availability", path: "/restaurant/availability" },
        { name: "Reservation", path: "/client/reservation" },
        { name: "View Dining History", path: "/restaurant/history" },
      ],
    },
  ]
  ...
  const serviceItems = [
    {
      name: "Orders and Services",
      icon: <ShoppingBag size={20} />,
      path: "",
      id: "orders",
      submenu: [
        { name: "Orders", path: "/client/orders" },
        { name: "Order Status", path: "/client/orders/status" },
        { name: "Request Additional Services", path: "/client/orders/additional" },
        { name: "Modify Orders/Requests", path: "/client/orders/modify" },
        { name: "View Order History", path: "/client/orders/history" },
        { name: "Feedback", path: "/client/orders/feedback" },
      ],
    },
    {
      name: "Billing",
      ...
      id: "billing",
      submenu: [
        { name: "View Current Bill", path: "/billing/current" },
        { name: "Pay for Services", path: "/billing/pay" },
        { name: "Partial Payments", path: "/billing/partial" },
        { name: "Download/Print Invoices", path: "/billing/invoices" },
        { name: "View Payment History", path: "/billing/history" },
      ],
    },
    {
      name: "Feedback",
          ...
          <div className="flex items-center gap-1 sm:gap-2 md:gap-4">
            ...
            <div className="flex items-center gap-2 md:gap-3 rounded-full border border-gray-200 bg-white px-2 py-1 sm:px-3 sm:py-1.5 hover:border-amber-200 hover:shadow-md transition-all cursor-pointer" onClick={openLogoutModal}>
              ...
              <div className="hidden md:block pr-1">
                <p className="text-sm font-medium text-gray-900 truncate max-w-[120px] lg:max-w-[180px]">{user?.name || "Guest"}</p>
                <p className="text-xs text-amber-600">{user?.role || "Client"}</p>
              </div>
        ...
        <div className="flex h-full flex-col overflow-hidden rounded-xl sm:rounded-2xl bg-white border border-gray-100 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.1)]">
          <div className="flex h-14 sm:h-16 items-center justify-between border-b border-gray-100 px-4 sm:px-6 lg:hidden">
            <div className="flex items-center gap-3">
              ...
              <span className="text-base sm:text-lg font-bold text-gray-900">Hotel Tech</span>
            </div>
            <button
              onClick={toggleSidebar}
          ...
          <div className="border-t border-gray-100 p-3 sm:p-6">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm sm:font-medium text-gray-900 truncate">{user?.name || "Guest"}</p>
                <p className="text-xs text-amber-600">{user?.role || "Client"}</p>
              </div>
              <button 
