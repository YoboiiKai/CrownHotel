...
export default function AdminLayout({ children }) {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { name: "Bookings", path: "/rooms/bookings" },
    ...
    },
    {
      ...
      id: "restaurant",
      submenu: [
        { name: "Add Menu", path: "/restaurant/add-menu" },
        { name: "Manage Orders", path: "/restaurant/orders" },
        { name: "Table Management", path: "/restaurant/tables" },
        { name: "Promotions", path: "/restaurant/promotions" },
        { name: "Discounts", path: "/restaurant/discounts" },
        { name: "Reservation", path: "/restaurant/reservation" },
        { name: "Table Status", path: "/restaurant/table-status" },
      ],
    },
    {
      name: "Inventory",
      ...
      submenu: [
        ...
        { name: "Purchase Orders", path: "/inventory/orders" },
      ],
    },
    {
      name: "Reservation",
      ...
      id: "reservations",
      submenu: [
        { name: "Add Reservation", path: "/reservations/add" },
        { name: "Reservation Calendar", path: "/reservations/calendar" },
        { name: "Event Reservations", path: "/reservations/events" },
      ],
    },
  ]
  ...
  const serviceItems = [
    ...
    },
    {
      ...
      id: "housekeeping",
      submenu: [
        { name: "Add Task", path: "/housekeeping/add-task" },
        { name: "Track Task Status", path: "/housekeeping/status" },
        { name: "Scheduled Maintenance", path: "/housekeeping/scheduled" },
      ],
    },
    {
      name: "Feedback",
      ...
      submenu: [
        ...
        { name: "Respond to Feedback", path: "/feedback/respond" },
        { name: "Track Satisfaction", path: "/feedback/satisfaction" },
      ],
    },
  ]
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="relative">
                ...
                <div className="relative h-7 w-7 sm:h-10 sm:w-10 items-center justify-center rounded-xl bg-gradient-to-br from-amber-600 to-amber-900 text-white shadow-lg">
          ...
          <div className="flex items-center gap-1 sm:gap-2 md:gap-4">
            ...
            <div className="flex items-center gap-2 md:gap-3 rounded-full border border-gray-200 bg-white px-2 py-1 sm:px-3 sm:py-1.5 hover:border-amber-200 hover:shadow-md transition-all cursor-pointer" onClick={openLogoutModal}>
              ...
              <div className="hidden md:block pr-1">
                <p className="text-sm font-medium text-gray-900 truncate max-w-[120px] lg:max-w-[180px]">{user?.name || "User"}</p>
                <p className="text-xs text-amber-600">{user?.role || "Hotel Staff"}</p>
              </div>
        ...
        <div className="flex h-full flex-col overflow-hidden rounded-xl sm:rounded-2xl bg-white border border-gray-100 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.1)]">
          <div className="flex h-14 sm:h-16 items-center justify-between border-b border-gray-100 px-4 sm:px-6 lg:hidden">
            <div className="flex items-center gap-3">
              ...
              <span className="text-base sm:text-lg font-bold text-gray-900">LuxStay</span>
            </div>
            <button
              onClick={toggleSidebar}
          ...
          <div className="border-t border-gray-100 p-3 sm:p-6">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm sm:font-medium text-gray-900 truncate">{user?.name || "User"}</p>
                <p className="text-xs text-amber-600">{user?.role || "Hotel Staff"}</p>
              </div>
              <button 
