...
export default function AdminLayout({ children }) {
    ...
    useEffect(() => {
        ...
        const setActiveMenuFromUrl = () => {
            ...
            if (!foundExactMatch) {
                const parentMenu = allMenus.find(
                    (item) =>
                        item.path &&
    ...
    const menuItems = [
        ...
        },
        {
            ...
            id: "users",
            submenu: [
                { name: "Clients", path: "/Admin/AdminClient" },
                { name: "Employees", path: "/Admin/AdminEmployee" },
            ],
        },
        {
            name: "Attendance",
        ...
        },
        {
            ...
            id: "rooms",
            submenu: [
                { name: "Rooms", path: "/Admin/AdminRooms" },
                { name: "Bookings", path: "/Admin/Bookings" },
                { name: "Booking Calendar", path: "/Admin/BookingCalendar" },
            ],
        },
        {
            name: "Reservation",
            ...
            submenu: [
                {
                    ...
                    path: "/Admin/AdminReservationCalendar",
                },
                { name: "Event Reservations", path: "/Admin/AdminEventReservation" },
            ],
        },
        {
            name: "Restaurant",
            ...
            id: "restaurant",
            submenu: [
                { name: "Add Menu", path: "/Admin/AdminMenu" },
                { name: "POS Menu", path: "/Admin/AdminPosMenu" },
                { name: "Manage Orders", path: "/Admin/AdminOrders" },
    ...
    const serviceItems = [
        {
            ...
            id: "billing",
            submenu: [
                { name: "Add Invoice", path: "/Admin/Billing/add-invoice" },
                { name: "Payments", path: "/Admin/Billing/payments" },
                { name: "Revenue", path: "/Admin/Billing/revenue" },
                { name: "Reports", path: "/Admin/Billing/reports" },
            ],
        },
        {
            name: "Housekeeping",
            ...
            id: "housekeeping",
            submenu: [
                { name: "Add Task", path: "/Admin/AdminTask" },
                { name: "Scheduled Maintenance", path: "/Admin/Task/scheduled" },
            ],
        },
        {
            ...
            submenu: [
                ...
                { name: "Satisfaction", path: "/Admin/Feedback/satisfaction" },
            ],
        },
    ];
                ...
                <div className="mx-auto flex items-center justify-between rounded-xl sm:rounded-2xl bg-gradient-to-r from-[#8B5A2B] to-[#6B4226] px-3 py-2 sm:px-4 sm:py-3 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.1)] border border-[#5D3A1F]">
                    <div className="flex items-center gap-2 sm:gap-3">
                        <button
                            ...
                            className="rounded-full p-1.5 sm:p-2 text-white hover:bg-[#6D4C41] transition-colors lg:hidden"
                        ...
                        <div className="flex items-center gap-2 sm:gap-3">
                            <div className="flex items-center gap-2 sm:gap-3">
                                ...
                                <div className="flex flex-col">
                                    <span className="text-sm sm:text-lg font-bold text-white leading-tight font-serif">
                                        CROWN of the ORIENT
                                    </span>
                                    <span className="hidden sm:inline-block text-xs text-[#DEB887] font-medium">
                                        BEACH RESORT
                                    </span>
                                </div>
                            </div>
                    ...
                    <div className="flex items-center gap-1 sm:gap-2 md:gap-4">
                        ...
                        <div
                            className="flex items-center gap-2 md:gap-3 rounded-full border border-[#5D3A1F] bg-[#8B5A2B]/60 px-2 py-1 sm:px-3 sm:py-1.5 hover:border-[#7C5E42] hover:shadow-md transition-all cursor-pointer"
