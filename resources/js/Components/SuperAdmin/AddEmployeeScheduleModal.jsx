...
import { Calendar, X, Users, Building2, Clock, CalendarDays, FileText } from 'lucide-react';

function AddEmployeeScheduleModal({
    isOpen,
    onClose,
    onSubmit,
    newSchedule,
                    ...
                    <form onSubmit={onSubmit} ref={formRef} className="space-y-6">
                        ...
                        <div className="p-4 bg-gradient-to-r from-[#A67C52]/10 to-[#8B5A2B]/10 rounded-lg border border-[#DEB887]/30 mb-6 relative overflow-hidden">
                            ...
                            <div className="relative z-10 flex items-start gap-3">
                                ...
                                <div>
                                    <h3 className="font-medium text-[#5D3A1F]">Employee Schedule Information</h3>
                                    <p className="text-sm text-[#6B4226]/70 mt-1">
                                        Create a new schedule by selecting an employee, department, date, and shift details.
                                    </p>
                                </div>
                            </div>
                        </div>
