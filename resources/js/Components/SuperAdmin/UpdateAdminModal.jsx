    ...
    if (Object.keys(newErrors).length > 0) {
      ...
      axios.post(`/api/admins/${admin.id}`, formDataToSend, {
        ...
        .then(response => {
          ...
          // First update the data via onSubmit
          if (onSubmit) {
            onSubmit();
          }
        ...
        <div className="bg-gradient-to-r from-[#5D3A1F] to-[#8B5A2B] px-6 py-5">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-bold text-white">Update Admin</h3>
                <p className="text-xs text-white/80">Modify administrator account details</p>
              </div>
            </div>
            <button 
              onClick={onClose} 
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="p-4 bg-gradient-to-r from-[#A67C52]/10 to-[#8B5A2B]/10 rounded-lg border border-[#DEB887]/30 mb-6 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h4 className="text-sm font-medium text-[#5D3A1F] mb-1">Admin Information</h4>
                <p className="text-xs text-[#6B4226]/70">Update admin account details below.</p>
              </div>
            </div>
