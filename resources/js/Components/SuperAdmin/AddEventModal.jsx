...
export default function AddEventModal({ show, onClose, onSubmit, fetchEvents }) {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('/api/events', formDataToSend, {
      headers: {
      ...
      .catch(error => {
        ...
        if (error.response && error.response.data) {
          if (error.response.data.errors) {
            ...
            setErrors({ general: "An error occurred while creating the event" })
